...
1) The precent_return for the first day  in the list will be undefined

2) The list is in assending order, so the most recent date is the last 
   item on the list. And, the first item on the list is the oldest date.

3) The oldest date and the most recent date may not be the same as the 
   iso_start_date and the iso_end_date.
